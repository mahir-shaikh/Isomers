...
export class ImportFileComponent implements OnInit {
    ...
    onFileSelect(event) {
        ...
        reader.onload = function (e) {
            ...
            const res = e.target['result'].split('sep=,\n').join('');
            const jsonOb = self.csvFileReader.getDataAsJSON(res, ',');
            // const jsonOb = self.csvFileReader.getDataAsJSON(e.target['result'], ',');

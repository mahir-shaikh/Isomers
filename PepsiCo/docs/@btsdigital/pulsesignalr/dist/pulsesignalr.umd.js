(function (global, factory) {
	...
	(factory((global.pulsesignalr = {}),global.core));
    ...
    SignalRService.prototype.initialiseConnection = function () {
        ...
        if (this.startConnectionPromise) {
            ...
            this.startConnectionPromise = new Promise(function (resolve, reject) {
                ...
                _this.connectionEstablished = new core.EventEmitter();
                _this.eventmessageReceived = new core.EventEmitter();
                _this.groupmessageReceived = new core.EventEmitter();
                _this.clientmessageReceived = new core.EventEmitter();

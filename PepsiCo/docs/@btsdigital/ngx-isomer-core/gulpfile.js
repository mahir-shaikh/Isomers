...
rollupCommonJs = require('rollup-plugin-commonjs'),
  rollupAMD = require('rollup-plugin-amd'),
  rollupNodeResolve = require('rollup-plugin-node-resolve');

const rootFolder = path.join(__dirname);
const srcFolder = path.join(rootFolder, 'src/app/isomer');
const btsCoreStylesFolder = path.join(srcFolder, 'bts-core-styles');
...
const externals = [
  ...
  'numeral/numeral',
  'moment/moment',
  '@btsdigital/jscalc/dist/jsCalc.min',
  '@btsdigital/jscalc/dist/jsCalc.src',
  '@btsdigital/pulsesignalr',
  '@btsdigital/pulseutilities',
  '@btsdigital/highcharts-formatter-plugin',
  'highcharts',
...
gulp.task('rollup:fesm', function () {
  return gulp.src(`${buildFolder}/**/*.js`)
    ...
    .pipe(rollup({
      ...
      format: 'es',
      plugins: [rollupNodeResolve(), rollupAMD()]
    }))
...
gulp.task('rollup:umd', function () {
  return gulp.src(`${buildFolder}/**/*.js`)
    ...
    .pipe(rename('ngx-isomer-core.umd.js'))
    .pipe(gulp.dest(distFolder));
});
...
/**
 * 12. Copy bts-core-styles to /dist
 */
gulp.task('copy:bts-core-styles', function () {
  return gulp.src([`${btsCoreStylesFolder}/**/*`])
    .pipe(gulp.dest(distFolder + '/bts-core-styles'));
});

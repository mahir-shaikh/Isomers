import { ChangeDetectionStrategy, ChangeDetectorRef, Component, Directive, ElementRef, EventEmitter, HostListener, Injectable, Input, NgModule, Output, Pipe, ViewChild } from '@angular/core';
...
import { SignalRModule, SignalRService } from '@btsdigital/pulsesignalr';
import * as numeral from 'numeral/numeral';
import { Router } from '@angular/router';
import { create } from 'nouislider';
import { BsDropdownModule } from 'ngx-bootstrap';
import { merge } from 'lodash';
import * as _Highcharts from 'highcharts/js/highcharts';
...
var CommunicatorService = (function () {
    ...
    CommunicatorService.prototype.createEmitter = function (emitterKey) {
        ...
        this.emitters.setValue(emitterKey, new Subject$1());
    };
    /**
...
var ManifestService = (function () {
    ...
    ManifestService.prototype.setConfig = function (config) {
        ...
        this._state = new BehaviorSubject$1(this.configuration);
...
var SyncStatusService = (function () {
    function SyncStatusService() {
       ...
       */
        this._lastSyncTime = new BehaviorSubject$1(null);
        /**
       * current active status private variable for Status
       */
        this._status = new BehaviorSubject$1(SyncStatus.OutOfSync);
        /**
       * current status of download & private variable for DownloadStatus
       */
        this._downloadStatus = new BehaviorSubject$1(SyncStatus.OutOfSync);
        /**
       * current status of model state & private variable for ModelStateStatus
       */
        this._modelStateStatus = new BehaviorSubject$1(SyncStatus.OutOfSync);
        /**
      ...
      */
       ...
       */
        this._aggregatedStatus = new BehaviorSubject$1(SyncStatus.OutOfSync);
        /**
...
var ConnectThrottlerService = (function () {
    ...
    */
    function ConnectThrottlerService(connect, syncStatusService) {
        ...
        */
        this.syncEmitter = new Subject$1();
        /**
        * Emits errors that are found while sync
        */
        this.errorEmitter = new Subject$1();
        /**
    ...
    SyncService.prototype.initializeSync = function () {
        ...
        if (this.connectToPulse) {
            ...
            calcPromise_1.then(function (api) {
                ...
                _this.dlSubscription = new IntervalObservable$1(30000).subscribe(_this.Download);
            });
...
CalcSliderComponent.propDecorators = {
    ...
    'format': [{ type: Input },],
    'scaler': [{ type: Input },],
    'elRef': [{ type: ViewChild, args: ['calcSliderEl',] },],
};
...
var TextService = (function () {
    ...
    function TextService(http$$1, calcService, logger, communicator) {
         ...
         *
         */
        this.textContent = new Dictionary();
        /**
    ...
    TextService.prototype.addScene = function (scene) {
        this.textContent.setValue(scene.ID, new Dictionary());
    ...
    TextService.prototype.init = function () {
        ...
        this.textContent.setValue(Constants.TEXT_ENGINE.GENERAL, new Dictionary());
...
CalcStepperComponent.propDecorators = {
    ...
    'inRef': [{ type: Input },],
    'outRef': [{ type: Input },],
    'inputScaler': [{ type: Input },],
    'outputMin': [{ type: Input },],
    'outputMax': [{ type: Input },],
    'inputValueRef': [{ type: ViewChild, args: ['inputValue',] },],
    ...
    ChartUtilsService.prototype.getDefaultsFor = function (types) {
        ...
        if (types && types.length) {
            types.forEach(function (type) {
                merge(opt, _this.getDefaultsOptionsForChart(type));
            });
        }
        return opt;
    };
...
var ChartComponent = (function () {
    ...
    ChartComponent.prototype.renderChart = function () {
        ...
        var opt = {};
        merge(opt, defaults, this.chartOptions, this.chartConfig);
...
ChartComponent.propDecorators = {
    ...
    'xAxis': [{ type: Input },],
    'yAxis': [{ type: Input },],
    'seriesOptions': [{ type: Input },],
    'chartOptions': [{ type: Input },],
    'chartElem': [{ type: ViewChild, args: ['chartelem',] },],
};
...
export { IsomerCoreModule, CalcModule, CalcOutputComponent, CalcInputComponent, CalcDropdownComponent, CalcSliderComponent, CalcCheckboxComponent, CalcOptionComponent, CalcStepperComponent, CalcService, CalcModelLoadedGuard, CalcFormatterDirective, ChartModule, ChartComponent, ChartUtilsService, ServicesModule, CommunicatorService, LoggerService, StorageService, NumberFormattingPipe, ManifestService, SignalRWrapperService, Constants, ConnectModule, SyncComponent, HttpWrapperService, ConnectThrottlerService, ConnectService, JsCalcConnectorService, SyncService, SyncStatusService, TextEngineModule, TextOutputComponent, TextService };

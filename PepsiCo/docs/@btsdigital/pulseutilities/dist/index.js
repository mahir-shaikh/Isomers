...
})(CriteriaForState || (CriteriaForState = {}));
...
var XLSXParser = (function () {
    function XLSXParser() {
        this.uploadedXls = new EventEmitter();
    }
        ...
        this._uploadedXls = this.filesSubject.asObservable()
            ...
            return new Observable(function (observer) {
                ...
                return wb.SheetNames.map(function (sheetName) {
                    ...
                    var utils1 = utils.sheet_to_json(sheet, { header: 1 });
                    return utils1;
                });
            }).map(function (results) {
                return { result: 'success', payload: results };
            })
                .catch(function (e) { return Observable.of({ result: 'failure', payload: e }); });
        });
...
var HierarchyComponent = (function () {
    function HierarchyComponent(gws) {
        ...
        this.favouriteChange = new EventEmitter();
...
HierarchyComponent.propDecorators = {
    ...
    'controls': [{ type: Input },],
    'filter': [{ type: Input },],
    'rootMetadata': [{ type: Input },],
    'contentChange': [{ type: Output },],
    'favouriteChange': [{ type: Output },],
};
...
SearchKeyPipe.decorators = [
    { type: Pipe, args: [{ name: 'searchKeys' },] },
];
/** @nocollapse */
...
SearchFilterOnObjectPipe.decorators = [
    { type: Pipe, args: [{ name: 'searchFilterOnObjectKey' },] },
];
/** @nocollapse */
...
export { LoggerService, GatewayService, PulseUtilitiesModule, HierarchyComponent, CoFilterPipe, FavComponent, SearchKeyPipe, SearchFilterOnObjectPipe, SwitchComponent, ChannelEvent, ChannelEventName, Channels, MessageFor, ContentObject, COSection, HierarchyEmmitOptions, CriteriaType, CriteriaForState, Delivery, XLSXParser, ParticipantOverview, VoteResponse, Question, Section };

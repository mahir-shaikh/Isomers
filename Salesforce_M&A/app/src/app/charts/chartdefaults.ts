...
export class ChartDefaults {
    ...
    getDefaults():any {
        ...
        let defaults = {
            ...
            colors: ['#0055b0', '#44458c', '#3d1071', '#bfbfbf', '#333', '#010637', '#928ef1', '#bcf08d', '#a65c34', '#ff4261', '#45dbcb', '#69261b', '#ff5050'],
            credits: {
                enabled: false
            },
            xAxis: {
    ...
    getStackedColumnChartDefaults(numberFormat?:string,totalName?:string) {
        let chartData = {
            chart: {
                type: 'column'
            },
            ...
            yAxis: {
                ...
                stackLabels: {
                    ...
                    formatter: function() {
                        if (numberFormat) {
                            return numberFormatting.format(this.total, numberFormat);
                        }
                        else {
                            return this.total;
                        }
            ...
            tooltip: {
                ...
                pointFormatter: function() {
                    if (numberFormat) {
                        return this.series.name + ": " + numberFormatting.format(this.y, numberFormat) + "<br />" + totalName +": " + numberFormatting.format(this.total, numberFormat);
                    }
                    else {
    ...
    getBasicColumnChartDefaults(numberFormat?:string,categoryFormat?:string,dataLabelFormat?:string) {
        let chartData = {
            chart: {
                type: 'column'
            },
            ...
            plotOptions: {
                column: {
                    ...
                    dataLabels: {
                        ...
                        formatter: function() {
                            if(dataLabelFormat){
                                return numberFormatting.format(this.y, dataLabelFormat);

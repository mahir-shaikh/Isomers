import { Component, Input, ViewChild, Directive, ElementRef, OnInit, OnDestroy, EventEmitter, OnChanges, SimpleChanges, HostListener } from '@angular/core';
...
export class BasicColumnComponent implements OnDestroy, OnInit, OnChanges {
    ...
    InitializeModel(){
        ...
        this.chartData = this.chartDefaults.getBasicColumnChartDefaults(this.numberFormat, this.categoryFormat,this.dataLabelFormat);
        ...
        self.chartData.chart.width = self.width;
            ...
            for (let i=0; i<this.localSeriesLabelsArray.length; i++) {
                ...
                for (let j=0; j<this.localCategoryLabelsArray.length; j++) {
                    ...
                    localData = this.calcService.getValueForYear(localRange, this.year);
                    try {

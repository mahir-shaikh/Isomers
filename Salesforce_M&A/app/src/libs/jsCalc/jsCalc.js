    ...
    */
    jsCalc.prototype.setValue = function (rangeID, value) {
        ...
        if (window.isArray(value)) {
            ...
            if (value == null) value = '';
            //[^\x00-\x7F]+
            // regex from http://stackoverflow.com/questions/150033/regular-expression-to-match-non-english-characters?answertab=active#tab-top
            var regEx = new RegExp(/[A-z|\x00-\x7F]/i);

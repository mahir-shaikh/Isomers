...
@Component({
    selector: 'feedbacktextandtable',
    templateUrl: './feedbacktextandtable.html',
    styleUrls: ['./feedbacktextandtable.css'],
    providers: []
})

export class FeedbackTextAndTable implements OnInit {
    @Input() index;
    @Input() feedback = {};

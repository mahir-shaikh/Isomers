...
export class ChartDefaults {
    ...
    getDefaults():any {
        ...
        let defaults = {
            ...
            colors: ['#28324b', '#4f7345', '#006EB9', '#feab41', '#6868b5', '#7BA96B', '#28324B', '#ee7423', '#FB054B', '#BEC0C1'],
            credits: {
                enabled: false
            },
            xAxis: {
            ...
            plotOptions: {
                column: {
                    ...
                    dataLabels: {
                        ...
                        formatter: function() {
                            if (numberFormat) {
                                return this.point.myData || numberFormatting.format(this.y, numberFormat);
                            }
                            else {
                                return this.point.myData || this.y;
                            }
                        },
                        color: 'black',
                        style: this.getDataLabelDefaultStyle()

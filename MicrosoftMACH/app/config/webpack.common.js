...
const APP_STORAGE_PREFIX = process.env.APP_STORAGE_PREFIX = process.env.APP_STORAGE_PREFIX = 'microsoft-skillup';
...
module.exports = {
  ...
  // Workaround for angular/angular#11580
    ...
    new webpack.optimize.CommonsChunkPlugin({
      name: ['app', 'model', 'vendor', 'polyfills']
    }),

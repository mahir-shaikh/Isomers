...
@NgModule({
    imports: [
        ...
        ViewsModule,
        ConnectModule,
        ChartsModule.forRoot(require('highcharts'), require('highcharts/highcharts-more'), require('highcharts/modules/solid-gauge'), require('highcharts/modules/heatmap'), require('highcharts/modules/exporting'),require('highcharts/modules/offline-exporting')),
        TabsModule.forRoot(), 

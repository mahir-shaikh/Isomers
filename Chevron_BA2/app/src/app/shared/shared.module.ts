...
@NgModule({
    ...
    declarations: [SplashComponent, TooltipComponent, LogoutComponent, ProjectChooserComponent, ProjectComponent],
    exports: [SplashComponent, TooltipComponent, LogoutComponent, ProjectChooserComponent, ProjectComponent],
